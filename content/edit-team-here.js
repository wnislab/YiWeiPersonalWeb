 ...
 * Email and website are optional. Use an empty string when unavailable.
 * Put member photos in assets/images/team/.
 */
window.SITE_CONTENT = window.SITE_CONTENT || {};

window.SITE_CONTENT.team = {
  heading: "Research community",
  introduction:
    "Members of the WNIS Lab research community at Saint Louis University.",
  members: [
    {
      name: "Dr. Nan Cen",
      position: "Ph.D. Advisor",
